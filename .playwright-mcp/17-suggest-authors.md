- generic [active] [ref=e1]:
  - generic [ref=e5]:
    ...
    - generic [ref=e34]:
      ...
      - generic [ref=e5035]:
        - generic [ref=e5036]:
          - heading "Suggest authors" [level=1] [ref=e5038]
          - generic [ref=e5040]:
            - text: Try in sandbox
            - generic [ref=e5041]: 
        - paragraph [ref=e5044]: Retrieve the author URI for a given author name.
        - paragraph [ref=e5047]:
          - paragraph [ref=e5048]:
            - text: Use this API endpoint to map the author name to the author URI that can be used when specifying the
            - code [ref=e5049]: authorUri
            - text: filter in various API calls. Since it's possible that there are multiple authors with the same name you can also specify the source domain name in the query (e.g. 'amy more nytimes.com') to make sure that the returned author will come from the news source of interest.
          - paragraph [ref=e5050]: The returned value will contain an array of author candidates that match the input name. The returned list is sorted based on the number of articles that we have collected from the author.
        - generic [ref=e5052]:
          - text: Endpoint
          - generic [ref=e5054]: GET | POST
          - text: https://eventregistry.org/api/v1/suggestAuthorsFast
        - generic [ref=e5056]: "HeadersContent-Type: application/json"
        - generic [ref=e5059]:
          - generic [ref=e5061]:
            - button "Code examples" [ref=e5063] [cursor=pointer]
            - button "Example output" [ref=e5065] [cursor=pointer]
            - button "Output schema" [ref=e5067] [cursor=pointer]
          - generic [ref=e5070]:
            - button "Example 1" [ref=e5074] [cursor=pointer]
            - generic [ref=e5077]:
              - paragraph [ref=e5080]: Find the list of authors whose name contain word "Koenig".
              - generic [ref=e5083]: Request body
        - generic [ref=e5085]:
          - generic [ref=e5089] [cursor=pointer]:
            - generic [ref=e5091]: 
            - generic [ref=e5092]: Parameters
          - generic [ref=e5095]:
            - generic [ref=e5097]:
              - generic [ref=e5099]: apiKey string (required)
              - paragraph [ref=e5102]: Your API key
            - generic [ref=e5104]:
              - generic [ref=e5106]: prefix string
              - paragraph [ref=e5109]: Partial or full name of the author.
