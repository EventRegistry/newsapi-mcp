- generic [active] [ref=e1]:
  - generic [ref=e5]:
    ...
    - generic [ref=e34]:
      ...
      - generic [ref=e5187]:
        - generic [ref=e5188]:
          - heading "Suggest event types" [level=1] [ref=e5190]
          - generic [ref=e5192]:
            - text: Try in sandbox
            - generic [ref=e5193]: 
        - paragraph [ref=e5196]: Retrieve the event type URI for a given event type label/prefix.
        - paragraph [ref=e5199]:
          - paragraph [ref=e5200]:
            - text: Use this API endpoint to map the event type label into the event type URI that can be used when specifying the
            - code [ref=e5201]: eventTypeUri
            - text: filter when querying mentions. The provided label can also be a partial name.
          - paragraph [ref=e5202]: The returned value will contain an array of event types that match the input label.
        - generic [ref=e5204]:
          - text: Endpoint
          - generic [ref=e5206]: GET | POST
          - text: https://eventregistry.org/api/v1/eventType/suggestEventTypes
        - generic [ref=e5208]: "HeadersContent-Type: application/json"
        - generic [ref=e5213]:
          - button "Example output" [ref=e5215] [cursor=pointer]
          - button "Output schema" [ref=e5217] [cursor=pointer]
        - generic [ref=e5225]:
          - generic [ref=e5227]:
            - generic [ref=e5228]: apiKey
            - generic [ref=e5229]: string
            - generic [ref=e5230]: (required)
          - paragraph [ref=e5233]: Your API key
        - generic [ref=e5237]:
          - generic [ref=e5239]:
            - generic [ref=e5240]: prefix
            - generic [ref=e5241]: string
          - paragraph [ref=e5244]: Partial or full name of the event type.
